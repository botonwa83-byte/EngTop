...
enum KnowledgePracticeFactory {
    static func questions(for point: JuniorKnowledgePoint) -> [KnowledgePracticeQuestion] {
        ...
        let generated = [
            KnowledgePracticeQuestion(id: point.id + "-example", knowledgePointID: point.id, prompt: "哪一项是“\(point.title)”的正确示例？", options: [example] + distractors.compactMap(\.examples.first), answer: 0, explanation: point.summary),
